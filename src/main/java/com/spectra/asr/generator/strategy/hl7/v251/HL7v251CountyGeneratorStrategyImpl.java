...
@Slf4j
public class HL7v251CountyGeneratorStrategyImpl extends StateHL7GeneratorStrategyImpl {
	//private Logger log = Logger.getLogger(HL7v251CountyGeneratorStrategyImpl.class);

...
@Slf4j
public class MugsiEIPHssfGeneratorStrategyImpl extends EIPHssfGeneratorStrategyImpl {
	//private Logger log = Logger.getLogger(MugsiEIPHssfGeneratorStrategyImpl.class);

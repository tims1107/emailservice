...
@Slf4j
public class CommonCountyHL7GeneratorStrategyImpl extends StateHL7GeneratorStrategyImpl {
	//private Logger log = Logger.getLogger(CommonCountyHL7GeneratorStrategyImpl.class);

package com.spectra.asr.generator.strategy.hssf.state;
...
@Slf4j
public class StateHssfGeneratorStrategyImpl extends HssfGeneratorStrategyImpl {
	// Logger log = Logger.getLogger(StateHssfGeneratorStrategyImpl.class);

...
@Slf4j
public class AbcEIPStateAllHssfGeneratorStrategyImpl extends EIPHssfGeneratorStrategyImpl {
	//private Logger log = Logger.getLogger(AbcEIPStateAllHssfGeneratorStrategyImpl.class);

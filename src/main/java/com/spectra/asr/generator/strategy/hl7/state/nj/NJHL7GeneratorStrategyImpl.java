package com.spectra.asr.generator.strategy.hl7.state.nj;
...
@Slf4j
public class NJHL7GeneratorStrategyImpl extends StateHL7GeneratorStrategyImpl {
	//private Logger log = Logger.getLogger(NJHL7GeneratorStrategyImpl.class);
/*	

package com.spectra.asr.generator.strategy.hssf.eip.mugsi;
...
@Slf4j
public class MugsiEIPStateAllHssfGeneratorStrategyImpl extends EIPHssfGeneratorStrategyImpl {
	//private Logger log = Logger.getLogger(MugsiEIPStateAllHssfGeneratorStrategyImpl.class);
		...
		if(dtoList != null){
			if(this.generatorDto != null){
				if(this.targetList == null){
					...
					// TEST REMOVE !!
					//targetListStr += ",CA,MS,MA,NM,GA,NJ";
					// END TEST REMOVE !!
				...
				if((targetDtoList != null) && (targetDtoList.size() > 0)){
					...
					MugsiEIPHssfBo bo = AsrBoFactory.getMugsiEIPHssfBo();
					Workbook wb = null;
					if(bo != null){

...
import com.spectra.asr.businessobject.hl7.v251.TXHL7Bo;
...
// Copy class
@Slf4j
public class TXHL7GeneratorStrategyImpl extends StateHL7GeneratorStrategyImpl {
	//private Logger log = Logger.getLogger(TXHL7GeneratorStrategyImpl.class);
	...
	public Map<String, List<HL7Dto>> generate(List<StateResultDto> dtoList){
		...
		if(dtoList != null){
			if(this.generatorDto != null){
				...
				// ** add code **
				TXHL7Bo bo = AsrBoFactory.getTXHL7v251Bo();
				HL7Dto hl7Dto = null;
				if(bo != null){
					try{

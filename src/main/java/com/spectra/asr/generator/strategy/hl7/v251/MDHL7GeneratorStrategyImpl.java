...
import com.spectra.asr.businessobject.hl7.v251.MDHL7Bo;
...
@Slf4j
public class MDHL7GeneratorStrategyImpl extends StateHL7GeneratorStrategyImpl {
	//private Logger log = Logger.getLogger(MDHL7GeneratorStrategyImpl.class);
	...
	public Map<String, List<HL7Dto>> generate(List<StateResultDto> dtoList){
		...
		if(dtoList != null){
			if(this.generatorDto != null){
				...
				MDHL7Bo bo = AsrBoFactory.getMDHL7v251Bo();
				HL7Dto hl7Dto = null;
				if(bo != null){
					try{

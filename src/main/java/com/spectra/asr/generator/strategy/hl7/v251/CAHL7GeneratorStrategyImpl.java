...
import com.spectra.asr.businessobject.hl7.v251.ORHL7Bo;
...
//import com.spectra.scorpion.framework.exception.BusinessException;
@Slf4j
public class CAHL7GeneratorStrategyImpl extends StateHL7GeneratorStrategyImpl {
	//private Logger log = Logger.getLogger(CAHL7GeneratorStrategyImpl.class);
	...
	public Map<String, List<HL7Dto>> generate(List<StateResultDto> dtoList){
		...
		if(dtoList != null){
			if(this.generatorDto != null){
				//System.out.println(this.generatorDto);
				log.warn("generate(): generatorDto: " + (generatorDto.getEastWestFlag() == null ? "NULL" : generatorDto.getEastWestFlag()));
				//System.out.println(this.generatorDto.getStateTarget() + " " + this.getTargetList());
				...
				ORHL7Bo bo = AsrBoFactory.getCAHL7v251Bo();
				HL7Dto hl7Dto = null;
				if(bo != null){
					try{

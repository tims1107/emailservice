...
@Slf4j
public class ORHL7GeneratorStrategyImpl extends StateHL7GeneratorStrategyImpl {
	//private Logger log = Logger.getLogger(ORHL7GeneratorStrategyImpl.class);
	...
	public Map<String, List<HL7Dto>> generate(List<StateResultDto> dtoList){
		...
		if(dtoList != null){
			if(this.generatorDto != null){
				...
				ORHL7Bo bo = AsrBoFactory.getORHL7v251Bo();
				HL7Dto hl7Dto = null;
				if(bo != null){
					try{

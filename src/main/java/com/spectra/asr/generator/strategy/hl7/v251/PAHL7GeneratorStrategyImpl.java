...
import com.spectra.asr.businessobject.hl7.v251.PAHL7Bo;
...
//import com.spectra.scorpion.framework.exception.BusinessException;
@Slf4j
public class PAHL7GeneratorStrategyImpl extends StateHL7GeneratorStrategyImpl {
	//private Logger log = Logger.getLogger(PAHL7GeneratorStrategyImpl.class);
	...
	public Map<String, List<HL7Dto>> generate(List<StateResultDto> dtoList){
		...
		if(dtoList != null){
			if(this.generatorDto != null){
				...
				PAHL7Bo bo = AsrBoFactory.getPAHL7v251Bo();
				HL7Dto hl7Dto = null;
				if(bo != null){
					try{

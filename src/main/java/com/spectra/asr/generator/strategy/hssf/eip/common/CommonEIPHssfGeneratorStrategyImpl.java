...
@Slf4j
public class CommonEIPHssfGeneratorStrategyImpl extends EIPHssfGeneratorStrategyImpl {
	//private Logger log = Logger.getLogger(CommonEIPHssfGeneratorStrategyImpl.class);

package com.spectra.asr.generator.strategy.hl7.state.county.nj;
...
@Slf4j
public class NJCountyHL7GeneratorStrategyImpl extends StateHL7GeneratorStrategyImpl {
	//private Logger log = Logger.getLogger(NJCountyHL7GeneratorStrategyImpl.class);

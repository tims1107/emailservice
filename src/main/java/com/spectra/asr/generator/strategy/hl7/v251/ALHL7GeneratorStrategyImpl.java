...
import com.spectra.asr.businessobject.hl7.v251.ALHL7Bo;
...
@Slf4j
public class ALHL7GeneratorStrategyImpl extends StateHL7GeneratorStrategyImpl {
	//private Logger log = Logger.getLogger(ALHL7GeneratorStrategyImpl.class);
	...
	public Map<String, List<HL7Dto>> generate(List<StateResultDto> dtoList){
		...
		if(dtoList != null){
			if(this.generatorDto != null){
				...
				// ** add code **
				ALHL7Bo bo = AsrBoFactory.getALHL7v251Bo();
				HL7Dto hl7Dto = null;
				if(bo != null){
					try{

package com.spectra.asr.generator.strategy.hssf;
...
@Slf4j
public abstract class HssfGeneratorStrategyImpl implements GeneratorStrategy<Workbook, StateResultDto> {
	//private Logger log = Logger.getLogger(HssfGeneratorStrategyImpl.class);

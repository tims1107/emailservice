package com.spectra.asr.generator.strategy.hl7.v23.noaddr;
...
@Slf4j
public class HL7v23NoaddrGeneratorStrategyImpl extends StateHL7GeneratorStrategyImpl {
	//private Logger log = Logger.getLogger(HL7v23NoaddrGeneratorStrategyImpl.class);

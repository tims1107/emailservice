package com.spectra.asr.generator.context.hssf.eip;
...
@Slf4j
public class EIPHssfGeneratorContextImpl implements GeneratorContext<Workbook, StateResultDto> {
	//private Logger log = Logger.getLogger(EIPHssfGeneratorContextImpl.class);

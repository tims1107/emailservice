...
// copy class
@Slf4j
public class ALHL7BoImpl implements HL7v251Bo {
	//private Logger log = Logger.getLogger(ALHL7BoImpl.class);
	...
	public HL7Dto toHL7Dto(Map<String, List<PatientRecord>> listMap, GeneratorDto generatorDto) throws BusinessException {
		...
		if((listMap != null) && (generatorDto != null)){
			// ** Adapter ** //
			HL7Creator hl7Creator = (HL7Creator) HL7CreatorFactory.getCreatorImpl("ALHL7Creator");
			if(hl7Creator != null){

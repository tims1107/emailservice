...
// copy class
@Slf4j
public class TXHL7BoImpl implements HL7v251Bo {
	//private Logger log = Logger.getLogger(TXHL7BoImpl.class);
	...
	public HL7Dto toHL7Dto(Map<String, List<PatientRecord>> listMap, GeneratorDto generatorDto) throws BusinessException {
		...
		if((listMap != null) && (generatorDto != null)){
			// ** Adapter ** //
			HL7Creator hl7Creator = (HL7Creator)HL7CreatorFactory.getCreatorImpl("TXHL7Creator");
			if(hl7Creator != null){

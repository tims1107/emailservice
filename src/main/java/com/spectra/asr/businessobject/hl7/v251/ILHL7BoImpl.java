...
@Slf4j
public class ILHL7BoImpl implements HL7v251Bo {
	//private Logger log = Logger.getLogger(ILHL7BoImpl.class);
	...
	public HL7Dto toHL7Dto(Map<String, List<PatientRecord>> listMap, GeneratorDto generatorDto) throws BusinessException {
		...
		if((listMap != null) && (generatorDto != null)){
			HL7Creator hl7Creator = (HL7Creator)HL7CreatorFactory.getCreatorImpl("ILHL7Creator");
			if(hl7Creator != null){

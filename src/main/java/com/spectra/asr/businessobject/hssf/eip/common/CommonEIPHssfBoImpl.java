package com.spectra.asr.businessobject.hssf.eip.common;
...
@Slf4j
public class CommonEIPHssfBoImpl implements CommonEIPHssfBo {
	//private Logger log = Logger.getLogger(CommonEIPHssfBoImpl.class);
		...
		if((listMap != null) && (generatorDto != null)){
			...
			if(generatorDao != null){
				...
				for(StateResultDto stateResultDto : stateResultDtoList){
					String sourceState = stateResultDto.getSourceState();
					if((sourceState != null) && (sourceState.equalsIgnoreCase("facility"))){
						stateResultDto.setPatientAccountAddress1("");
						stateResultDto.setPatientAccountAddress2("");
						stateResultDto.setPatientAccountCity("");
						stateResultDto.setPatientAccountState("");
						stateResultDto.setPatientAccountZip("");
					}

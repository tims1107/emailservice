...
public class PatientRecord implements Serializable {
	...
	private static final String HL7_CODESYSTEM = "HL7";
	...
	public String getEthnicGroup() {
		if (ethnicGroup == null || ethnicGroup.toUpperCase().equals("OTHER")) return "Unknown";
		return ethnicGroup;
	}


	public String getPAEthnicGroupCode() {
		String eGroup = getEthnicGroup().toUpperCase().substring(0,1);
		switch (eGroup) {
			case "H":
				return eGroup;
	...
	public String getHl7Codesystem() {
		return HL7_CODESYSTEM;
	}

	public String getRaceCode() {
		String patientrace = getPatientRace().toUpperCase().substring(0,1);
		switch (patientrace) {
			case "W":
				return "2106-3";
			case "B":
	...
	public String getRaceString23(){
		return getPatientRace().toUpperCase().substring(0,1);
	}

	public String getPatientRace() {
		if (patientRace == null) {
			return "Other Race";
		} else if(patientRace.startsWith("Asked")) {
			return "Other Race";
		}
	...
	//	this.facility_phone_number = this.facility_phone_number.replaceAll("-", "");
		...
		try {
			...
			log.error("Patient Master phone error, {}",getOrderNumber());
		}

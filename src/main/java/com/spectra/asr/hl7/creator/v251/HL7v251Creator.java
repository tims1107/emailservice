...
@Slf4j
public class HL7v251Creator extends AbstractHL7Creator {
	//private Logger log = Logger.getLogger(HL7v251Creator.class);
	...
	public AbstractMessage getMessage(PatientRecord patientRecord, Map<String, Object> paramMap) throws HL7Exception {
		...
		if((patientRecord != null) && (paramMap != null)){
			HL7Message hl7Msg = HL7MessageFactory.getHL7v251Message();

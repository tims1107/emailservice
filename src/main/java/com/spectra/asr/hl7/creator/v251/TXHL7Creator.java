...
import com.spectra.asr.hl7.creator.TXAbstractHL7Creator;
...
@Slf4j
public class TXHL7Creator extends TXAbstractHL7Creator {
	//private Logger log = Logger.getLogger(TXHL7Creator.class);
	...
	public AbstractMessage getMessage(PatientRecord patientRecord, Map<String, Object> paramMap) throws HL7Exception {
		...
		if((patientRecord != null) && (paramMap != null)){
			HL7Message hl7Msg = HL7MessageFactory.getTXHL7v251Message();

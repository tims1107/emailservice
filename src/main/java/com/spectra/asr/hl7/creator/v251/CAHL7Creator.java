...
import com.spectra.asr.hl7.creator.CAAbstractHL7Creator;
...
@Slf4j
public class CAHL7Creator extends CAAbstractHL7Creator {
	//private Logger log = Logger.getLogger(CAHL7Creator.class);
	...
	public AbstractMessage getMessage(PatientRecord patientRecord, Map<String, Object> paramMap) throws HL7Exception {
		...
		if((patientRecord != null) && (paramMap != null)){
			HL7Message hl7Msg = HL7MessageFactory.getCAHL7v251Message();

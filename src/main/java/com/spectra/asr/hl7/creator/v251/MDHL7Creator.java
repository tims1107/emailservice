...
import com.spectra.asr.hl7.creator.MDAbstractHL7Creator;
...
@Slf4j
public class MDHL7Creator extends MDAbstractHL7Creator {
	//private Logger log = Logger.getLogger(MDHL7Creator.class);
	...
	public AbstractMessage getMessage(PatientRecord patientRecord, Map<String, Object> paramMap) throws HL7Exception {
		...
		if((patientRecord != null) && (paramMap != null)){
			HL7Message hl7Msg = HL7MessageFactory.getMDHL7v251Message();

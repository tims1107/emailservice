...
import com.spectra.asr.hl7.creator.ORAbstractHL7Creator;
...
@Slf4j
public class ORHL7Creator extends ORAbstractHL7Creator {
	//private Logger log = Logger.getLogger(ORHL7Creator.class);
	...
	public AbstractMessage getMessage(PatientRecord patientRecord, Map<String, Object> paramMap) throws HL7Exception {
		...
		if((patientRecord != null) && (paramMap != null)){
			HL7Message hl7Msg = HL7MessageFactory.getORHL7v251Message();

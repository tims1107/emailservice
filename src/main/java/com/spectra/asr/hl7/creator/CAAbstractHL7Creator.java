...
import java.util.*;
@Slf4j
public abstract class CAAbstractHL7Creator implements HL7Creator {
	//private Logger log = Logger.getLogger(CAAbstractHL7Creator.class);
...
//				}
				...
				Date bhstime = Calendar.getInstance().getTime();
...
//				fhsBuilder.append(fileReceivingFacility).append("\n");
				...
				fhsBuilder.append("FHS|^~\\&|Spectra Labs^2.16.840.1.114222.4.3.22.29.7.1^ISO|Spectra East^31D0961672^CLIA|NCDPH NCEDSS^2.16.840.1.113883.3.591.3.1^ISO|NCDPH EDS^2.16.840.1.113883.3.591.1.1^ISO|");
				fhsBuilder.append(sdf.format(bhstime));
				fhsBuilder.append("||" + sdf.format(bhstime) + "\n");
...
//				bhsBuilder.append(fileReceivingFacility).append("\n");
				...
				bhsBuilder.append("BHS|^~\\&|Spectra Labs^2.16.840.1.114222.4.3.22.29.7.1^ISO|Spectra East^31D0961672^CLIA|NCDPH NCEDSS^2.16.840.1.113883.3.591.3.1^ISO|NCDPH EDS^2.16.840.1.113883.3.591.1.1^ISO|");
				bhsBuilder.append(sdf.format(bhstime));
				bhsBuilder.append("||" + sdf.format(bhstime) + "\n");
				//end header builder

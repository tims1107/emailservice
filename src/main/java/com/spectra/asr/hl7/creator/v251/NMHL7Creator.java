...
import com.spectra.asr.hl7.creator.NMAbstractHL7Creator;
...
@Slf4j
public class NMHL7Creator extends NMAbstractHL7Creator {
	//private Logger log = Logger.getLogger(NMHL7Creator.class);
	...
	public AbstractMessage getMessage(PatientRecord patientRecord, Map<String, Object> paramMap) throws HL7Exception {
		...
		if((patientRecord != null) && (paramMap != null)){
			HL7Message hl7Msg = HL7MessageFactory.getNMHL7v251Message();

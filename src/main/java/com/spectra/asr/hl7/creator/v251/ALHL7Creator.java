...
import com.spectra.asr.hl7.creator.ALAbstractHL7Creator;
...
@Slf4j
public class ALHL7Creator extends ALAbstractHL7Creator {
	//private Logger log = Logger.getLogger(ALHL7Creator.class);
	...
	public AbstractMessage getMessage(PatientRecord patientRecord, Map<String, Object> paramMap) throws HL7Exception {
		...
		if((patientRecord != null) && (paramMap != null)){
			HL7Message hl7Msg = HL7MessageFactory.getALHL7v251Message();

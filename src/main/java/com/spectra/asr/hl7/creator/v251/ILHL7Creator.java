...
import com.spectra.asr.hl7.creator.ILAbstractHL7Creator;
...
@Slf4j
public class ILHL7Creator extends ILAbstractHL7Creator {
	//private Logger log = Logger.getLogger(ILHL7Creator.class);
	...
	public AbstractMessage getMessage(PatientRecord patientRecord, Map<String, Object> paramMap) throws HL7Exception {
		...
		if((patientRecord != null) && (paramMap != null)){
			HL7Message hl7Msg = HL7MessageFactory.getILHL7v251Message();
...
//		System.exit(0);
	...
	public String getPipedHL7Message(AbstractMessage hl7Message, Map<String, Object> paramMap) throws HL7Exception {
		...
		if(hl7Message != null){
			...
			System.out.println("Message \r" + hl7Str);
		}

...
import java.util.*;
@Slf4j
public abstract class MDAbstractHL7Creator implements HL7Creator {
	//private Logger log = Logger.getLogger(MDAbstractHL7Creator.class);
	...
	public HL7Dto toHL7Dto(Map<String, List<PatientRecord>> listMap, GeneratorDto generatorDto) throws BusinessException {
		...
		if((listMap != null) && (generatorDto != null)){
			...
			if(generatorDao != null){
				...
				String infoSpectraNameSE = null;
				String infoSpectraAddressSE = null;
				String infoSpectraAddress2SE = null;
				String infoSpectraCitySE = null;
				String infoSpectraStateSE = null;
				String infoSpectraZipSE = null;
				String infoSpectraPhoneSE = null;
				String medicalDirectorSE = "Alex Ryder M.D.";

				String infoSpectraNameSH = null;
				String infoSpectraAddressSH = null;
				String infoSpectraAddress2SH = null;
				String infoSpectraCitySH = null;
				String infoSpectraStateSH = null;
				String infoSpectraZipSH = null;
				String infoSpectraPhoneSH = null;
				String medicalDirectorSH = "Alex Ryder M.D.";
...
//				}
				...
				infoSpectraNameSH = ApplicationProperties.getProperty("spectra.south.info.name");
				infoSpectraAddressSH = ApplicationProperties.getProperty("spectra.south.info.address");
				infoSpectraAddress2SH = ApplicationProperties.getProperty("spectra.south.info.address2");
				infoSpectraPhoneSH = ApplicationProperties.getProperty("spectra.south.info.phone");

				infoSpectraNameSE = ApplicationProperties.getProperty("spectra.east.info.name");
				infoSpectraAddressSE = ApplicationProperties.getProperty("spectra.east.info.address");
				infoSpectraAddress2SE = ApplicationProperties.getProperty("spectra.east.info.address2");
				infoSpectraPhoneSE = ApplicationProperties.getProperty("spectra.east.info.phone");


				String[] addr2Array = infoSpectraAddress2SE.split("\\s");
				if (addr2Array.length == 3) {
					infoSpectraCitySE = addr2Array[0].substring(0, addr2Array[0].indexOf(","));
					infoSpectraStateSE = addr2Array[1];
					infoSpectraZipSE = addr2Array[2];
				}

				addr2Array = null;

				addr2Array = infoSpectraAddress2SH.split("\\s");
				if (addr2Array.length == 3) {
					infoSpectraCitySH = addr2Array[0].substring(0, addr2Array[0].indexOf(","));
					infoSpectraStateSH = addr2Array[1];
					infoSpectraZipSH = addr2Array[2];
				}
...
//				}
				...
				pMap.put("infoSpectraAddressSE", infoSpectraAddressSE);
				pMap.put("infoSpectraAddress2SE", infoSpectraAddress2SE);
				pMap.put("infoSpectraCitySE", infoSpectraCitySE);
				pMap.put("infoSpectraStateSE", infoSpectraStateSE);
				pMap.put("infoSpectraZipSE", infoSpectraZipSE);
				pMap.put("medicalDirectorSE", medicalDirectorSE);
				pMap.put("infoSpectraAddressSH", infoSpectraAddressSH);
				pMap.put("infoSpectraAddress2SH", infoSpectraAddress2SH);
				pMap.put("infoSpectraCitySH", infoSpectraCitySH);
				pMap.put("infoSpectraStateSH", infoSpectraStateSH);
				pMap.put("infoSpectraZipSH", infoSpectraZipSH);
				pMap.put("medicalDirectorSH", medicalDirectorSH);

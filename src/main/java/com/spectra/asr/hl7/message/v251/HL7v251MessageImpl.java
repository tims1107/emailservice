...
@Slf4j
public class HL7v251MessageImpl implements HL7Message {
	...
	public AbstractMessage getMessage(PatientRecord patientRecord, Map<String, Object> paramMap) {
		...
		if(patientRecord != null){
			...
			String infoSpectraAddress = ApplicationProperties.getProperty("spectra." + "south" + ".info.address");
			//String infoSpectraAddress2 = (String)paramMap.get("infoSpectraAddress2");
			String infoSpectraAddress2 = ApplicationProperties.getProperty("spectra." + "south" + ".info.address2");
			//String infoSpectraCity = (String)paramMap.get("infoSpectraCity");
			String infoSpectraCity = null; //ApplicationProperties.getProperty("spectra." + "south" + ".info.city");
			//String infoSpectraState = (String)paramMap.get("infoSpectraState");
			String infoSpectraState = null; //ApplicationProperties.getProperty("spectra." + "south" + ".info.state");
			//String infoSpectraZip = (String)paramMap.get("infoSpectraZip");
			String infoSpectraZip = null; //ApplicationProperties.getProperty("spectra." + "south" + ".info.zip");
...
//
//				pid.getRace(0).patientRecord.getRaceCode());
...
//				pid.getRace().getExtraComponents().getComponent(1).setData(pidce.getNameOfCodingSystem());
				...
				pid.getRace(0).getText().setValue(patientRecord.getRaceCode());

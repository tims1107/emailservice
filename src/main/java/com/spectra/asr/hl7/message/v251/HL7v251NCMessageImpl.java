...
@Slf4j
public class HL7v251NCMessageImpl implements HL7Message {
	//private Logger log = Logger.getLogger(HL7v251CAMessageImpl.class);
	
	@Override
	public AbstractMessage getMessage(PatientRecord patientRecord, Map<String, Object> paramMap) {

		//System.out.println("Processing CA DOH");
...
//		}
		...
		if(patientRecord != null){
			...
			}else if(patientRecord.getPerformingLabId().indexOf("SW") != -1){
...
//			}
			...
			try {
				...
				pid.getRace(0).getIdentifier().setValue("2131-1");
				...
				pid.getEthnicGroup(0).getIdentifier().setValue("2186-5");
				...
				orc.getOrc12_OrderingProvider(0).getAssigningAuthority().getUniversalIDType().setValue("CLIA");
...
*/					
					...
					for(int i = 0; i < obxList.size(); i++){
						...
						if((obxRecord.getSubTestCode() != null) &&
							...
							obx.getObx19_DateTimeOfTheAnalysis().getTs1_Time().setValue(releaseDateTimeBuilder.toString());

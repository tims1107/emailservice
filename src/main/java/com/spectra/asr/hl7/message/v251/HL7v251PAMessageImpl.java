...
@Slf4j
public class HL7v251PAMessageImpl implements HL7Message {
	//private Logger log = Logger.getLogger(HL7v251PAMessageImpl.class);
...
//
				...
				pid.getEthnicGroup(0).getIdentifier().setValue(patientRecord.getPAEthnicGroupCode());

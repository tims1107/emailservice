...
@Slf4j
public class HL7v251MDMessageImpl implements HL7Message {
	//private Logger log = Logger.getLogger(HL7v251MDMessageImpl.class);
...
//				}
				...
				//OBR 4.2
				//obr.getObr4_UniversalServiceIdentifier().getCe2_Text().setValue(obxRec.getLoincName());
				obr.getObr4_UniversalServiceIdentifier().getCe2_Text().setValue(obxRec.getLoincCommonName());
				//OBR 4.3
...
*/					
					...
					for(int i = 0; i < obxList.size(); i++){
						...
						if((obxRecord.getSubTestCode() != null) &&
							...
							switch (obxRecord.getMDTextualNumResult()){
								case "Positive":
								case "Negative":
								case "Reactive":
								case "Reactive 1:2":
							...
							if ((obxRecord.getLoincCode() != null) && (obxRecord.getLoincCode().length() > 0)) {
								...
								obx.getObservationIdentifier().getText().setValue(obxRecord.getLoincCommonName());

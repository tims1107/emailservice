...
public class DAILYRESULT {
    ...
    public DAILYRESULT(String ORDER_NUMBER, String PATIENT_TYPE, String LOINC_CODE, String LOINC_NAME, String ACCESSION_NUMBER, String EXTERNAL_MRN, Date RELEASE_DATE_TIME,
                       String ORDER_TEST_CODE, String ORDER_TEST_NAME, String RESULT_TEST_CODE, String RESULT_TEST_NAME, Date COLLECTION_DATE_TIME, Date COLLECTION_DATE,
                       String COLLECTION_TIME, String RESULT_STATUS, String SOURCE_LAB_SYSTEM, String DEVICE_ID, String RESULT_COMMENTS, String VALUE_TYPE,
                       Long NUMERIC_RESULT, String TEXTUAL_RESULT_FULL, String TEXTUAL_RESULT, String REFERENCE_RANGE, String ABNORMAL_FLAG, String PERFORMING_LAB_ID, String ORDER_METHOD, String SPECIMEN_SOURCE, String ORDER_DETAIL_STATUS, String UNITS, String NPI, String ORDERING_PHYSICIAN_NAME, String LOGGING_SITE, String PATIENT_ID, String REQUISITION_STATUS) {
    ...
    public Date getRELEASE_DATE_TIME() {
        ...
        cal.setTime(RELEASE_DATE_TIME);
        if(RELEASE_DATE_TIME == null){
            System.out.println(RELEASE_DATE_TIME);
        }
        //if(PERFORMING_LAB_ID.equals("SW") || PERFORMING_LAB_ID.equals("SWREF"))  cal.add(Calendar.HOUR,-3);

        System.out.println(PERFORMING_LAB_ID + " new time: " + cal.getTime());
        return cal.getTime();
    }
    ...
    public Long getNUMERIC_RESULT() {
        return NUMERIC_RESULT;
    }

    public void setNUMERIC_RESULT(Long NUMERIC_RESULT) {
        this.NUMERIC_RESULT = NUMERIC_RESULT;
    }
